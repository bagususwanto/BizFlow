...
export function CustomersTable({
  ...
  const handleBulkDelete = async () => {
    try {
      ...
      const response = await customersService.bulkDelete(ids);
      const message =
        (response as any).data?.message ||
        `${ids.length} pelanggan berhasil dihapus`;
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              akan dihapus. Jika pelanggan sudah memiliki riwayat transaksi,
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Pelanggan yang dipilih akan dihapus. Pelanggan dengan riwayat
              transaksi akan dinonaktifkan.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
